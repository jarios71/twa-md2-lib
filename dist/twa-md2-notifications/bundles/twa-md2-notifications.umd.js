(function (global, factory) {
    ...
    (global = global || self, factory(global['twa-md2-notifications'] = {}, global.ng.core, global.rxjs, global.rxjs.operators, global.ng.common, global.ng['flex-layout'], global.ng.material.card, global.ng.material.button, global.ng.material.icon, global.ng.cdk.overlay, global.ng.material.badge));
    ...
    var TwaMd2NotificationsService = /** @class */ (function () {
        ...
        /** @nocollapse */ TwaMd2NotificationsService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function TwaMd2NotificationsService_Factory() { return new TwaMd2NotificationsService(); }, token: TwaMd2NotificationsService, providedIn: "root" });
    ...
    var TWAMd2NotificationsComponent = /** @class */ (function () {
        ...
        function () {
            ...
            this.globalClick = rxjs.fromEvent(document, 'click').pipe(operators.delay(1), operators.tap((/**
             * @return {?}
             */
            function () {
        ...
        TWAMd2NotificationsComponent.propDecorators = {
            notifsService: [{ type: core.Input }],
            panelClicked: [{ type: core.Output }],
            notifPanel: [{ type: core.ViewChild, args: ['notifPanelContainer', { static: false },] }]
        };
