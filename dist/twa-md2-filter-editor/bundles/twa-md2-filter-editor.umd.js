        ...
        function TWAFilterEditorService() {
            ...
            this.processFilterOrs = function (filters) {
                ...
                filters.forEach(function (v, i) {
                    ...
                    if (v.isgroup) {
                        var newGroup = Object.assign(Object.assign({}, v), { fields: _this.processFilterOrs(v.fields) });
            ...
            this.activeFilters.map(function (filter, idx) {
                if (filter.isgroup) {
                    if (filter.fields.length === 0) {
                        ...
                        _this.activeFilters.splice(idx, 1, Object.assign({}, filter.fields[0]));
                    }
                    else {
